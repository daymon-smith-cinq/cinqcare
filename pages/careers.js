...
export default function Careers() {
  ...
  const metaDescription = "Join CINQCARE’s mission to deliver health and care to high-needs communities. Answer the call to make a difference—explore careers today.";
